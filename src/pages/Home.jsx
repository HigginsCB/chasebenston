    ...
    return (
        <div>
            <Grid container alignItems="center" justify="center" spacing={5} style={{ paddingTop: "25px" }}>
                <Grid item xs="4">
                    <img
                        src="https://media-exp1.licdn.com/dms/image/C4D03AQH6ilz88crKWg/profile-displayphoto-shrink_800_800/0/1582068283326?e=1623283200&v=beta&t=QIQy_wWBAImC0_doxjrRYyM2PALAXItLpCSzaoLMCDU"
                ...
                <Grid item xs="8">
                    <div>
                        ...
                        <Typography>Since graduation I have been keeping my development skills sharp by completing challenges on various websites (HackerRank, Leetcode, etc.) and collecting <Link to={'/chasebenston/awards'} style={{ color: "inherit" }}>awards</Link> such as badges and skill verifications. 
                            ...
                            In Februrary of 2021 I started with General Motors as a software developer with the online retail team using a Angular and .NET stack.
                            I occasionally help with my fiance's company (Vividly Bold) by consulting with clients on their wishes for WordPress site developments.
                        </Typography>
